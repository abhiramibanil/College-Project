      ...
      <form>
        ...
        <div className="form-group">
          ...
          <select id="course">
            ...
            <option value="course1">I st year</option>
            <option value="course2">II nd year</option>
            <option value="course2">III rd year</option>
            <option value="course2">Iv th year</option>
